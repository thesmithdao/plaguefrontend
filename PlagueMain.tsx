      ...
      <header className="fixed top-0 left-0 right-0 z-20 p-4 sm:p-6 bg-transparent backdrop-blur-sm">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <WalletMultiButton
              className="!bg-green-600 hover:!bg-green-700 !text-white !font-bold !text-xs sm:!text-sm !px-1 sm:!px-4 !py-1 sm:!py-2 !rounded-lg !border-2 !border-green-500 hover:!border-green-400 !transition-all !shadow-lg !min-h-[32px] sm:!min-h-[40px] !max-w-[100px] sm:!max-w-none !overflow-hidden !whitespace-nowrap !text-ellipsis"
              startIcon={undefined}
              onClick={(event) => {
        ...
        <div className="md:hidden mt-4">
          <div className="flex flex-wrap items-center justify-center gap-3">
            <button
              onClick={() => openModal("about")}
              className="text-gray-300 hover:text-green-400 transition-colors flex items-center gap-1 text-xs font-medium"
            >
      ...
      <main className="relative z-10 flex-1 flex items-center justify-center px-4 sm:px-6 py-8 sm:py-12 pt-48 sm:pt-32">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8 sm:mb-12 mr-0">
            <div className="text-2xl sm:text-4xl md:text-6xl font-light mb-6 sm:mb-8 text-white leading-tight">
              <div className="mb-2">A web3 marketing agency</div>
              <div>
